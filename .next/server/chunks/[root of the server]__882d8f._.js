...
const createData = async (data)=>{
    ...
    console.log("SENHA: " + saltedHashedPassword.salt + "       " + saltedHashedPassword.hashedPassword);
};
const passwordEncrypt = (password)=>{
    ...
    const hashedPassword = __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].pbkdf2Sync(password, salt, 1000, 64, 'sha512').toString('hex'); // Cria o hash
    return {
        salt,
        hashedPassword
    }; // Retorna hash e salt
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__882d8f._.js.map