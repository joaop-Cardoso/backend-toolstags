...
"[project]/src/app/api/routes/login/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const validateHash = (salt, storedHashedPassword, password)=>{
    const passwordValidate = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$util$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["padronizedHash"])(password, salt);
    return passwordValidate === storedHashedPassword;
};
async function POST(request) {
    try {
        ...
        console.error(err);
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"]('Error during login', {
            status: 500
        });
    }
}
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7cd59e._.js.map