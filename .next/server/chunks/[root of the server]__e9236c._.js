...
class PrismaClientSingleton {
    ...
    static getInstance() {
        ...
        if (!PrismaClientSingleton.instance) {
            PrismaClientSingleton.instance = new __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["PrismaClient"]({
                errorFormat: 'pretty'
            });
        }
...
"[project]/src/app/api/util/hash.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: require } = __turbopack_context__;
{
__turbopack_esm__({
    "padronizedHash": (()=>padronizedHash)
});
...
;
const padronizedHash = (password, salt)=>{
    return __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].pbkdf2Sync(password, salt, 10000, 128, 'sha512').toString('hex'); // Cria o hash
};
}}),
"[project]/src/app/api/routes/signin/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$crypto$2c$__cjs$29$__ = __turbopack_import__("[externals]/ [external] (crypto, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$util$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_import__("[project]/src/app/api/util/hash.ts [app-route] (ecmascript)");
;
;
;
;
...
const createData = async (data)=>{
    ...
    const fullData = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.create({
        data: {
            email: data.email,
...
const passwordEncrypt = (password)=>{
    ...
    const hashedPassword = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$util$2f$hash$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["padronizedHash"])(password, salt);
    __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].pbkdf2Sync(password, salt, 10000, 128, 'sha512').toString('hex'); // Cria o hash
    return {
        salt,
        hashedPassword
    }; // Retorna hash e salt
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e9236c._.js.map